...
**Execution Date**: 2026-08-02 19:53:11 UTC  
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **hypher + hyphenation-patterns** | `hypher` | hyphenation-patterns/patterns/id.js (published npm package, synced from convert_engine_format.js) | **99.99%** | **1** | 1 | 1 | **285.585** | 0.253s | 192.3 KB |
| **hypher + id-hyphenation-patterns** | `hypher` | id-hyphenation-patterns (github:mlengse/id-hyphenation-patterns) | **99.87%** | **0.9994** | 0.9992 | 0.9997 | **364.911** | 0.198s | 184.4 KB |
| **hyphen + hyphenation-patterns** | `hyphen` | hyphenation-patterns (github:mlengse/hyphenation-patterns) | **95.58%** | **0.99** | 0.9991 | 0.9811 | **450.869** | 0.1603s | 1650.7 KB |
| **hyphen + id-hyphenation-patterns** | `hyphen` | id-hyphenation-patterns (github:mlengse/id-hyphenation-patterns) | **95.59%** | **0.9901** | 0.9992 | 0.9812 | **177.302** | 0.4075s | 156.4 KB |
| **Hyphenopoly + hyphenation-patterns** | `Hyphenopoly` | hyphenation-patterns (github:mlengse/Hyphenopoly WASM) | **83.36%** | **0.9609** | 0.9992 | 0.9254 | **149.506** | 0.4833s | 127.5 KB |
| **Hyphenopoly + id-hyphenation-patterns** | `Hyphenopoly` | id-hyphenation-patterns (github:mlengse/Hyphenopoly min WASM) | **83.36%** | **0.9609** | 0.9992 | 0.9254 | **1.462.262** | 0.0494s | 2.7 KB |
